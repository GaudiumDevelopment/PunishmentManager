        ...
        Promise<Void> initPromise = Promise.start()
            ...
            Log.debug("Initializing tables")).thenRunAsync(() -> {
               ...
               try {
                     ...
                     final String createPlayer_joinsLeavesTable = "CREATE TABLE IF NOT EXISTS " + db + ".`player_joins/leaves` ( uuid                 varchar(50)  NOT NULL    , `join_date`          datetime  NOT NULL    , `leave_date`         datetime );";
                     final String createPlayer_IPTable = "CREATE TABLE IF NOT EXISTS " + db + ".`player_IP` ( `IP`                 varchar(18)  NOT NULL    , uuid                 varchar(50)  NOT NULL    , `creation_date`      datetime  NOT NULL );";
                     final String createPlayer_dataTable = "CREATE TABLE IF NOT EXISTS " + db + ".player_data ( uuid                 varchar(50)  NOT NULL    , playername           varchar(20)  NOT NULL );";
