        ...
        Promise<Void> initPromise = Promise.start()
            ...
            Log.debug("Initializing tables")).thenRunAsync(() -> {
               ...
               try {
                     ...
                     final String createPlayer_joinsTable = "CREATE TABLE IF NOT EXISTS "+ db + ".`player_joins` ( uuid                 varchar(50)  NOT NULL    , `join_date`          bigint UNSIGNED  NOT NULL, result                 varchar(20)  NOT NULL );";
                     ...
                     final String createPunishment_templatesTable = "CREATE TABLE IF NOT EXISTS " + db + ".punishment_templates ( `punishment_id`      int  NOT NULL    , threshold            int  NOT NULL    , `category_id`        int  NOT NULL    , `mute_calculation`   varchar(200)      , `ban_calculation`    varchar(200)      , `jail_calculation`   varchar(200)      , server               varchar(200) );";
