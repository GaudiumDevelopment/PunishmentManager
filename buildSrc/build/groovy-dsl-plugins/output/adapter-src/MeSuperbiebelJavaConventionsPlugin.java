...
/**
 * Precompiled me.superbiebel.java-conventions script plugin.
 **/
public class MeSuperbiebelJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MeSuperbiebelJavaConventions").asSubclass(BasicScript.class);
