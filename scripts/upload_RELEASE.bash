...
cd /Users/travis/
tar -cvzf PunishmentManager-build_$1+default_modules.tar PunishmentManager-build_$1


curl -T /Users/travis/PunishmentManager-build_$1+default_modules.tar -usuperbiebel:$2 -X PUT https://api.bintray.com/content/moderationmanager/PunishmentManager/RELEASE/build_$1/PunishmentManager+default_modules-build_$1.tar\?publish=1
